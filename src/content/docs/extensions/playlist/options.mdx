...
<div data-waveform-playlist data-layout="hero">
  <div data-track data-url="track-1.mp3" data-title="One"   data-subtitle="Artist" data-artwork="1.jpg"></div>
  <div data-track data-url="track-2.mp3" data-title="Two"   data-subtitle="Artist" data-artwork="2.jpg"></div>
  <div data-track data-url="track-3.mp3" data-title="Three" data-subtitle="Artist" data-artwork="3.jpg"></div>
</div>
```
...
| `showSubtitle` | `data-show-subtitle` | `boolean` | `true` | Show the now-playing subtitle in the hero/grid bar. `data-show-subtitle="false"` hides it. |
