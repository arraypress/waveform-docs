---
title: Tracker
description: Release history for @arraypress/waveform-tracker.
sidebar:
  order: 5
---
...
:::note
Generated from [`@arraypress/waveform-tracker`'s CHANGELOG](https://github.com/arraypress/waveform-tracker/blob/main/CHANGELOG.md). Run `npm run sync:changelogs` after a release to refresh.
:::
