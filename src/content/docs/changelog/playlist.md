---
title: Playlist
description: Release history for @arraypress/waveform-playlist.
sidebar:
  order: 3
---
...
:::note
Generated from [`@arraypress/waveform-playlist`'s CHANGELOG](https://github.com/arraypress/waveform-playlist/blob/main/CHANGELOG.md). Run `npm run sync:changelogs` after a release to refresh.
:::
