...
A small, zero-dependency family of vanilla-JS audio components — a canvas
waveform player and its extensions — configured from plain markup. Drop in a
script and a few `data-*` attributes and ship. ~10KB gzipped, no dependencies.
