...
When you swap tracks at runtime with [`loadTrack()`](/player/methods/#loadtrackurl-title-subtitle-options), some options are deliberately reset so the new track can't inherit stale state:
