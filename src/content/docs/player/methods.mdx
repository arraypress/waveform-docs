...
Pass a root to initialise only the part of the page you control — the usual pairing with the [`data-waveform-autoinit="false"` opt-out](/player/data-attributes/#initialising-only-what-you-control):
