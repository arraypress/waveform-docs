...
:::note
Cue markers carry their own per-marker `color` (defaulting to a translucent white), independent of the theme tokens. See [Markers](/player/markers/).
:::
...
The full set of class hooks (`.waveform-btn`, `.waveform-container`, `.waveform-title`, `.waveform-meta`, …) is documented under [CSS classes](/player/options/#css-classes) if you need finer-grained targeting.
