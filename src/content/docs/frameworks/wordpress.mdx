...
The fastest path — point WordPress at jsDelivr or unpkg. Pin to a major (`@1`) for automatic patch/minor updates, or to an exact version (`@1.22.0`) for reproducible builds.
