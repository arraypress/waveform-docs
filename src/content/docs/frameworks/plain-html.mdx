...
<html lang="en">
  <head>
    ...
    <link
      rel="stylesheet"
      href="https://cdn.jsdelivr.net/npm/@arraypress/waveform-player@latest/dist/waveform-player.css"
    />
  </head>
  <body>
    <div
    ...
    <script
      src="https://cdn.jsdelivr.net/npm/@arraypress/waveform-player@latest/dist/waveform-player.min.js"
    ></script>
  </body>
</html>
```
...
The package publishes a minified IIFE bundle and a stylesheet. The examples use `@latest` so you always get the current release; pin an exact version (e.g. `@1.23.0`) instead when you need fully reproducible builds.
...
<link rel="stylesheet"
  href="https://cdn.jsdelivr.net/npm/@arraypress/waveform-player@latest/dist/waveform-player.css" />
<script
  src="https://cdn.jsdelivr.net/npm/@arraypress/waveform-player@latest/dist/waveform-player.min.js"></script>
```
...
```html
<link rel="stylesheet"
  href="https://unpkg.com/@arraypress/waveform-player@latest/dist/waveform-player.css" />
<script
  src="https://unpkg.com/@arraypress/waveform-player@latest/dist/waveform-player.min.js"></script>
```
...
<Aside type="caution">
For fully reproducible builds, pin an **exact** version (for example `@1.23.0`) instead of `@latest`. A floating tag means a CDN-cached update can change behaviour without a deploy on your side.
</Aside>
...
<head>
  ...
  <link rel="stylesheet"
    href="https://cdn.jsdelivr.net/npm/@arraypress/waveform-player@latest/dist/waveform-player.css" />
  <link rel="stylesheet"
    href="https://cdn.jsdelivr.net/npm/@arraypress/waveform-bar@latest/dist/waveform-bar.css" />
</head>
<body>
  ...
  <script
    src="https://cdn.jsdelivr.net/npm/@arraypress/waveform-bar@latest/dist/waveform-bar.min.js"></script>
</body>
```
...
```bash
curl -O https://cdn.jsdelivr.net/npm/@arraypress/waveform-player@latest/dist/waveform-player.min.js
curl -O https://cdn.jsdelivr.net/npm/@arraypress/waveform-player@latest/dist/waveform-player.css
```
