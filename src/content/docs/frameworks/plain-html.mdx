...
<html lang="en">
  ...
  <body>
    <div
      ...
      data-subtitle="The Synthwave Collective"
...
Stylesheet order doesn't matter for correctness, but keep the core stylesheet present whenever any extension is on the page — the extensions render core players and rely on its classes. Continue with [Bottom bar](/bar/getting-started/) or [Playlist](/playlist/getting-started/) for each extension's markup and triggers.
...
<CardGrid>
  ...
  <Card title="Methods" icon="seti:javascript">
